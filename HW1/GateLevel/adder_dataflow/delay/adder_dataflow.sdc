...
# Created by write_sdc on Mon Sep 30 18:17:57 2024
...
set_max_area 0
create_clock -name clk  -period 0.085124  -waveform {0 0.042562}
set_max_delay 0.085124  -from [list [get_ports {a[31]}] [get_ports {a[30]}] [get_ports {a[29]}]       \
