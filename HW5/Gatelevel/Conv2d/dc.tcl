...
analyze -format verilog { 	
                            /home/B103040012_HDL/HDL/HW5/RTL/LineBuffer.v
                            /home/B103040012_HDL/HDL/HW5/RTL/Conv.v
}
elaborate $Top
...
uplevel #0 { report_timing  -through { step0/* } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group  > $Path_Syn/s1_timing_report.txt}
uplevel #0 { report_timing  -through { step1/* } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group  > $Path_Syn/s2_timing_report.txt}
