...
uplevel #0 { report_timing  -through { uut1/* } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group  > $Path_Syn/s1_timing_report.txt}
uplevel #0 { report_timing  -through { uut2/* } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group  > $Path_Syn/s2_timing_report.txt}
