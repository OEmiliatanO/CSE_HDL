...
# current_design $Top
analyze -format verilog { 	/home/B103040012_HDL/HDL/HW3/RTL/thumb.v }
elaborate $Top
...
uplevel #0 { report_timing  -through { step3/* } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group  > $Path_Syn/s2_timing_report.txt}
uplevel #0 { report_timing  -through { step4/* } -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group  > $Path_Syn/s2_timing_report.txt}
